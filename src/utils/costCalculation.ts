...
export function calculateTotalCost(values: FormValues): number {
  ...
  // Bridal package cost
  const packageKey =
    values.bridalPackage as keyof typeof pricingConfig.bridal.packages
  ...
  total +=
    values.weddingPartyPreview.hairMakeup *
    pricingConfig.weddingParty.preview.hairMakeup
  total +=
    values.weddingPartyPreview.hairOnly *
    pricingConfig.weddingParty.preview.hairOnly
  total +=
    values.weddingPartyPreview.makeupOnly *
    pricingConfig.weddingParty.preview.makeupOnly

  // Wedding day party costs
  total +=
    values.weddingDay.hairMakeup *
    pricingConfig.weddingParty.weddingDay.hairMakeup
  total +=
    values.weddingDay.hairOnly * pricingConfig.weddingParty.weddingDay.hairOnly
  total +=
    values.weddingDay.makeupOnly *
    pricingConfig.weddingParty.weddingDay.makeupOnly
  total +=
    values.weddingDay.juniorBridesmaid *
    pricingConfig.weddingParty.weddingDay.juniorBridesmaid
  total +=
    values.weddingDay.flowerGirl *
    pricingConfig.weddingParty.weddingDay.flowerGirl
  total +=
    values.weddingDay.blowDryShort *
  ...
  total +=
    values.stayOnService *
    pricingConfig.optionalExtras.stayOnService.pricePerHour
  total +=
    values.extraTime * pricingConfig.optionalExtras.extraTime.pricePerHour
  total +=
    values.outOfHours * pricingConfig.optionalExtras.outOfHours.pricePerHour
  ...
  total +=
    values.stripLashes * pricingConfig.optionalExtras.stripLashes.pricePerPerson
  total +=
    values.touchUpKit * pricingConfig.optionalExtras.touchUpKit.pricePerPerson
